...
## Load validation labels from the folder
label_dir = "val_masks/"
...
## Calculate the average DICE scores from the validation data (15 validation images and 15 masks)
...
## Calculate the average Precision scores from the validation data 
...
## Calculate the average RECALL scores from the validation data 
