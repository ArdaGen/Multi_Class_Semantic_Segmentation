...
## Calcuate the average DICE scores from the validation data (15 validation images and 15 masks)
...
## Calcuate the average Precision scores from the validation data 
...
## Calcuate the average RECALL scores from the validation data 
